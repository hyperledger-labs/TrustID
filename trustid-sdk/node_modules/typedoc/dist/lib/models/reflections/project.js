...
class ProjectReflection extends container_1.ContainerReflection {
    ...
    removeReflection(reflection, removeReferences = false) {
        var _a, _b;
        if (removeReferences) {
            for (const id of (_a = this.getReferenceGraph().get(reflection.id), (_a !== null && _a !== void 0 ? _a : []))) {
        ...
        (_b = parent) === null || _b === void 0 ? void 0 : _b.traverse((child, property) => {
            if (child !== reflection) {
                return true;
            }
        ...
        if (!this.referenceGraph) {
            ...
            for (const ref of Object.values(this.reflections)) {
                if (ref instanceof reference_1.ReferenceReflection) {
                    ...
                    if (target) {
                        const refs = (_a = this.referenceGraph.get(target.id), (_a !== null && _a !== void 0 ? _a : []));
                        refs.push(ref.id);
