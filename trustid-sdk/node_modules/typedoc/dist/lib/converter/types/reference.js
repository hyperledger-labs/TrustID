...
let ReferenceConverter = class ReferenceConverter extends components_1.ConverterTypeComponent {
    ...
    convertLiteral(context, symbol, node) {
        var _a;
        for (const declaration of (_a = symbol.declarations, (_a !== null && _a !== void 0 ? _a : []))) {
        ...
        declaration.flags.setFlag(index_2.ReflectionFlag.Exported, context.scope.flags.isExported);
        ...
        context.withScope(declaration, () => {
            var _a;
            (_a = symbol.declarations, (_a !== null && _a !== void 0 ? _a : [])).forEach((node) => {
