...
let CommentPlugin = CommentPlugin_1 = class CommentPlugin extends components_1.ConverterComponent {
    ...
    onResolve(context, reflection) {
        ...
        if (signatures.length) {
            ...
            signatures.forEach((signature) => {
                ...
                (_a = childComment) === null || _a === void 0 ? void 0 : _a.removeTags('param');
            });
            (_a = comment) === null || _a === void 0 ? void 0 : _a.removeTags('param');
        }
    }
    ...
    static removeTags(comment, tagName) {
        var _a;
        (_a = comment) === null || _a === void 0 ? void 0 : _a.removeTags(tagName);
    }
