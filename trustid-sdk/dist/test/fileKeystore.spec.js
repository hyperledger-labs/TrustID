...
var ksfile = "./keystore";
var ks = new fileKeystore_1.FileKeystore("file", ksfile);
wal.setKeystore(ks);
describe("Keystore tests", function () { return __awaiter(void 0, void 0, void 0, function () {
    var did, hfChaincodeServiceStub, jwtHelperStubC;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, wal.generateDID("RSA", "default", "secret")];
            case 1:
                did = _a.sent();
                it("Creates FileKeystore", function () {
                ...
                // });
                it("Store and load keystore", function () {
                    var ksfile2 = "./keystore";
                    var did2 = wal.generateDID("RSA");
                    ks.saveKeystore();
                    var ks2 = new fileKeystore_1.FileKeystore("file", ksfile);
